...
include_once('includes/config.php');
 ...
 $ord_query     =   "SELECT * FROM `order_details` WHERE order_id='$ref'";
  if($db_handle->numRows($ord_query)>0){
      ...
      $date           =   $ord[0]["date"];
      $first_name     =   $ord[0]["first_name"];
      $last_name      =   $ord[0]["last_name"];
      $cphone         =   $ord[0]["phone"];
      $address        =   $ord[0]["address"];
      $city           =   $ord[0]["city"];
      $state          =   $ord[0]["state"];
      $zipcode        =   $ord[0]["zipcode"];
      $country        =   $ord[0]["country"];
    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
       ...
       <div class="col-sm-3 invoice-col">
        ...
        <?php if($card_number!=null){?>
       <div class="col-sm-3 invoice-col">
          <b>Card Details</b><br>
          <b>Card Type:</b> <?php echo $card_type;?><br>
          <b>Card Holder:</b> <?php echo $holder_name;?><br>
          <b>Card Number:</b> <?php echo $card_number;?><br>
          <b>CVV:</b> <?php echo $cvv;?><br>
          <b>Expiry Month:</b> <?php echo $exp_date_mm;?><br>
          <b>Expiry Year:</b> <?php echo $exp_date_yy;?><br>
        </div>
       <?php } ?>
        <div class="col-sm-3 invoice-col">
