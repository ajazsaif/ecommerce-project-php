...
<html>
<head>
    <title><?php echo $page_title;?> | Payment Option Page</title>
    <?php 
    ...
    //run query 
    $cat_info_query     =   "select * from `privacy` where 1=1";
    ...
    if($db_handle->updateQuery("privacy",$fields,"id =1")){
        $msg    =   "Data Has benn Updated...";
        LoadFunction("privacy.php");
        $db_handle->Close();
        unset($db_handle);
    }
    else{
