...
if(isset($_POST['del_rec'])){
    ...
    if($db_handle->deleteQuery('ti_coupon',"id = $del_id")){
...
<html>
<head>
    <title><?php echo $page_title;?> | Coupon Code</title>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php 
                     ...
                     $cat_info_query        =   "SELECT * FROM `ti_coupon` ORDER BY id DESC";
                      $j = 1;
                    if($db_handle->numRows($cat_info_query)>0){
                        ...
                        $name           =   $row[$i]["coupon_code"];
                        $id             =   $row[$i]["id"];
                        //$image          =   $row[$i]["image"];
                        $description    =   $row[$i]["coupon_price"];
                ...
                <td><?php echo $j;?></td>
                  ...
                  <td class="col-md-2" align="center">
                      ...
                      <a href="<?php echo __WEBROOT__;?>/add-promo.php?token=<?php echo $id; ?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
