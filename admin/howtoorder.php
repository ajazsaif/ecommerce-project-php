...
<html>
<head>
    <title><?php echo $page_title;?> | Shipping Policy</title>
    <?php 
    ...
    //run query 
    $cat_info_query     =   "select * from `terms` where id=14";
    ...
    if($db_handle->updateQuery("terms",$fields,"id =14")){
        $msg    =   "Data Has benn Updated...";
        LoadFunction("howtoorder.php");
        $db_handle->Close();
        unset($db_handle);
    }
    else{
