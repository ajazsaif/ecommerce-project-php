...
<html>
<head>
    <title><?php echo $page_title;?> | Chat Code</title>
    <?php 
    ...
    //run query 
    $cat_info_query     =   "select * from `chat_code` where 1=1";
    ...
    if($db_handle->updateQuery("chat_code",$fields,"id =1")){
        $msg    =   "Data Has benn Updated...";
        LoadFunction("chat_code.php");
        $db_handle->Close();
        unset($db_handle);
    }
    else{
        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
             ...
             <div class="form-group">
                <label>Chat Code Script:</label>
                <div>
                  <textarea name="content" id="" rows="10" class="form-control"><?php echo $content;?></textarea>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
