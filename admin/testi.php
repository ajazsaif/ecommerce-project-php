...
if(isset($_POST['del_rec'])){
    ...
    if($db_handle->deleteQuery('ti_testi',"id = $del_id")){
      unlink("../images/testimonial/" . $_POST['image']);
       $msg = true;
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php 
                     ...
                     $cat_info_query        =   "SELECT * FROM `ti_testi` ORDER BY id DESC";
                      $j = 1;
                ...
                <td><?php echo $j;?></td>
                  ...
                  <!--<td><img src="../images/testimonial/<?php echo $image;?>" height="120" width="120"></td>-->
                  <td><?php echo strip_tags(htmlspecialchars_decode($description));?></td>
                  <td class="col-md-2" align="center">
                      <form action="<?php echo htmlspecialchars('');?>" method="post">
                      <a href="<?php echo __WEBROOT__;?>/add-testi.php?token=<?php echo $id; ?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
