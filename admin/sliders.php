...
if(isset($_POST['del_rec'])){
    ...
    if($db_handle->deleteQuery('ti_slider',"id = $del_id")){
      unlink("../images/sliders/" . $_POST['image']);
       $msg = true;
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php 
                     ...
                     $cat_info_query        =   "SELECT image,id FROM `ti_slider` ORDER BY id DESC";
                      $j = 1;
                ...
                <tr>
                <td><?php echo $j;?></td>
                  <td><img src="../images/sliders/<?php echo $image;?>" height="120" width="320"></td>
                  <td align="center">
                      <form action="<?php echo htmlspecialchars('');?>" method="post">
                      <a href="<?php echo __WEBROOT__;?>/add-slider.php?token=<?php echo $id; ?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
