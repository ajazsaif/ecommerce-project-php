...
<html>
<head>
    <title><?php echo $page_title;?> | Testimonial</title>
    <?php 
   ...
   //contact info add edit operation and fetch data from database
    if(isset($_GET["token"])){
        ...
        //run query 
        $contact_info_query =   "select * from `ti_testi` where id = '".$escape_token."'";
   ...
   //edit data operation 
        if(isset($_POST["submit"]) && isset($_GET['token'])){
            ...
            if(!empty($_FILES['img']['name'])){
                   $upload_img_name    = cwUpload('img','../images/','',TRUE,'../images/testimonial/','100','100'); 
                ...
                $error_msg  =   "Image Upload Failed try again !";
                    ...
                    if($db_handle->updateQuery("ti_testi",$fields,"id = '$escape_token'")){
                    unlink("../images/testimonial/" . $image);
                    $msg    =   true;
                    LoadFunction("testi.php");
                    $db_handle->Close();
                    unset($db_handle);
                    }
                else{
            ...
            if(isset($_POST["submit"]) && !isset($_GET['token'])){
                ...
                $error_msg  =   "Image Upload Failed try again !";
                    ...
                    if($db_handle->insertQuery("ti_testi",$fields)){
                    $msg    =   true;
                    LoadFunction("testi.php");
                    $db_handle->Close();
                    unset($db_handle);
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo __WEBROOT__?>/"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="<?php echo __WEBROOT__?>/testi.php"><i class="fa fa-quote-left"></i> Testimonial</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          if(isset($_GET['token'])){
          ?>
              <h3 class="box-title">Testimonial Edit Details</h3>
                <?php } else { ?>
                 <h3 class="box-title">Testimonial Add Details</h3>
                <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="file" name="img" style="float:left;" id="imgInp">
                    <img id="blah" src="../images/testimonial/<?php echo $image;?>" style="width:50px;">
                </div>
