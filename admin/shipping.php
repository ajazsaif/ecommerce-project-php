...
<html>
<head>
    <title><?php echo $page_title;?> | Terms & Condition</title>
    <?php 
    ...
    //run query 
    $cat_info_query     =   "select * from `terms` where id=15";
    ...
    if($db_handle->updateQuery("terms",$fields,"id =15")){
        $msg    =   "Data Has benn Updated...";
        LoadFunction("shipping.php");
        $db_handle->Close();
        unset($db_handle);
    }
    else{
