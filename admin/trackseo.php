...
<head>
    ...
    //run query 
    $cat_info_query     =   "select * from `track_seo` where 1=1";
    ...
    if($db_handle->updateQuery("track_seo",$fields,"id =1")){
        $msg    =   true;
        LoadFunction("trackseo.php");
        $db_handle->Close();
        unset($db_handle);
    }
    else{
        ...
        <div class="col-md-6">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title"> Track Page Seo Details</h3>
